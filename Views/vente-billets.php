...
<head>
  ...
  <title>Vente de Billets • Safari</title>
...
<body>
    ...
    <main class="main">
      ...
      <header class="header">
        <div>
          ...
          <p>Point de vente - Guichet principal</p>
        </div>
      </header>
      ...
      <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 24px;">
        ...
        <div class="card">
          <div class="card__header">
            <h3>Vente de billet - Processus guidé</h3>
          </div>
  ...
  <script>
    ...
    async function genererFacturePDF(billet) {
      ...
      doc.text('TRANSCO', pageWidth / 2, yPos, { align: 'center' });

      yPos += 8;
      doc.setFontSize(11);
      doc.setFont(undefined, 'normal');
      doc.text('Billet de transport', pageWidth / 2, yPos, { align: 'center' });
      ...
      doc.setTextColor(255, 255, 255);
      doc.setFont(undefined, 'bold');
      doc.text('PAYÉ', pageWidth - margin - statutWidth - 6, yPos - 1);
      ...
      doc.setFont(undefined, 'bold');
      const prixFormate = parseFloat(billet.prix_paye).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ' ');
