<!-- Sidebar Menu Ressources Humaines -->
<aside class="sidebar">
    ...
    <div class="sidebar__user">
        ...
        <div class="user__info">
            ...
            <div class="user__role"><?php echo e(ucfirst($_SESSION['role'] ?? 'viewer')); ?> - RH</div>
        </div>
    </div>
    ...
    <nav class="sidebar__nav">
        ...
        $modules = $permissionModel->getModulesAccessibles($_SESSION['role'] ?? 'viewer', 'RH');
